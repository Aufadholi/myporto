    ...
    <header className="fixed top-4  z-50 w-full max-w">
      <div
        className={`
          ...
          min-w-fit h-12 sm:h-14 px-3 sm:px-4 transition-all duration-500 ease-out overflow-hidden
        `}
      >
        {/* ICONS DI KIRI */}
